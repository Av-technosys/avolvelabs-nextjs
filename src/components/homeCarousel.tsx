...
const carouselData = [
  ...
  { id: 2, name: "Stephanie Paetow", role: "Business Owner of Salesforce ONE.CRM", companyLogo: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Volkswagen_logo_2019.svg", image: "https://media.istockphoto.com/id/1310814041/photo/portrait-of-a-businesswoman-standing-in-a-a-modern-office.jpg?s=612x612&w=0&k=20&c=rLDYEGaGfbFq6mJPLc2FHjc6KBKyJETu38y4a3x11cM=" },
  { id: 3, name: "Stephanie Paetow", role: "Business Owner of Salesforce ONE.CRM", companyLogo: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Volkswagen_logo_2019.svg", image: "https://media.istockphoto.com/id/1310814041/photo/portrait-of-a-businesswoman-standing-in-a-a-modern-office.jpg?s=612x612&w=0&k=20&c=rLDYEGaGfbFq6mJPLc2FHjc6KBKyJETu38y4a3x11cM=" },
  { id: 4, name: "Stephanie Paetow", role: "Business Owner of Salesforce ONE.CRM", companyLogo: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Volkswagen_logo_2019.svg", image: "https://media.istockphoto.com/id/1310814041/photo/portrait-of-a-businesswoman-standing-in-a-a-modern-office.jpg?s=612x612&w=0&k=20&c=rLDYEGaGfbFq6mJPLc2FHjc6KBKyJETu38y4a3x11cM=" },
  { id: 5, name: "Stephanie Paetow", role: "Business Owner of Salesforce ONE.CRM", companyLogo: "https://upload.wikimedia.org/wikipedia/commons/6/6d/Volkswagen_logo_2019.svg", image: "https://media.istockphoto.com/id/1310814041/photo/portrait-of-a-businesswoman-standing-in-a-a-modern-office.jpg?s=612x612&w=0&k=20&c=rLDYEGaGfbFq6mJPLc2FHjc6KBKyJETu38y4a3x11cM=" },
]
...
export default function HomeCarousel() {
  ...
  const toggleAutoScroll = React.useCallback(() => {
    ...
    isPlaying ? autoScroll.stop() : autoScroll.play()
              ...
              <Card className="rounded-[32px] bg-white shadow-2xl">
                <CardContent className="p-2">
                  <div className="pt-0 mt-0 ">
                    <img src={item.image} alt={item.name} className="rounded-[32px]" />
                  </div>
                  <div className="pt-1  flex items-start gap-4">
                    <img src={item.companyLogo} alt="Logo" className="w-10 h-10 " />
                    <div>
                      <h3 className="font-bold text-[#032d60] font-playfair text-lg">{item.name}</h3>
                      <p className="text-sm text-gray-600 leading-tight font-poppins">{item.role}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
