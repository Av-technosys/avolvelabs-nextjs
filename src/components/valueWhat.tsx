    ...
    <section className="relative overflow-hidden bg-white px-5 pb-20 pt-16 sm:px-8 md:pb-28 md:pt-24 lg:px-12">
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
          ...
          >
            ...
            <div className="relative border-l border-[#c5d7f5] pl-6 md:pl-8">
              ...
              <p className="text-[15.5px] leading-[1.72] text-[#3d4b61]">
                Value Added Service is the complete platform that empowers your service teams to deliver seamless support across every channel — from the contact centre, to the field, to HR, and now IT Service.
                <br />
                <br />
                With humans and AI agents working together on one unified, metadata-based platform, you can transform every customer interaction into a personalised experience while driving efficiency.
              </p>
            </div>
          ...
          >
            <h2 className="max-w-[650px] font-playfair text-3xl font-bold leading-[1.2] text-[#0b1425] md:text-[46px] md:pl-10">
