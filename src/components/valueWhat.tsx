      ...
      >
        <section className="text-center px-8 pb-10">
          ...
          <p className="font-poppins text-sm md:text-lg text-gray-700 max-w-4xl mx-auto mt-8 leading-relaxed">
            Value Added Service is the complete platform that empowers your service teams to
        ...
        <div className="flex flex-row items-center justify-center gap-1 md:gap-3 mt-10 px-2">
            ...
            <Button 
              className="cursor-pointer font-poppins bg-[#0176d3] hover:bg-[#015ba3] text-white px-6 py-6 rounded-lg text-base font-semibold transition-all duration-300 shadow-md"
            >
              Find out more
            </Button>
            </Link>
