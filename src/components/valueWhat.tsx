      ...
      <div className="relative overflow-hidden">
        <section className="text-center px-8 pb-10">
          ...
          <p className="font-poppins text-sm md:text-lg text-gray-700 max-w-4xl mx-auto mt-8 leading-relaxed">
            Value Added Service is the complete platform that empowers your
            service teams to deliver seamless support across every channel —
            from the contact centre, to the field, to HR, and now IT Service.
            With humans and AI agents working together on one unified,
            metadata-based platform, you can transform every customer
            interaction into a personalised experience while driving efficiency.
          </p>
