      ...
      <div className="relative z-20 w-full mb-10 overflow-hidden">
        ...
        >
          {duplicatedPartners.map((partner, index) => (
            <div 
              key={index} 
              className="flex-shrink-0 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-50 p-6 w-48 h-28 flex items-center justify-center transition-transform hover:scale-105"
            >
              <Image
              width={600}
              height={600}
