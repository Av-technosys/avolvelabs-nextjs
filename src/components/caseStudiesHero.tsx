  ...
  return (
    <section className={styles.pageHero}>
      ...
      <div className={styles.pageHeroInner}>
        ...
        >
          See how we&apos;ve helped leading organizations overcome complex challenges, unify their systems, and drive scalable revenue growth through intelligent design and implementation.
        </motion.p>
