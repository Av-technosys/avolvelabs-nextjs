          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="slide-up">
              ...
              <p className="mt-4 max-w-xl font-poppins text-md md:text-[18px] text-gray-700 leading-relaxed ">
                We are a product-minded team designing practical AI systems for
                growth, automation, and insight. Join us to ship meaningful work
                with high standards and real impact.
              </p>
              <div className="mt-8 flex flex-wrap items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                ...
                <a
                  href="#apply"
                  className="rounded-full font-poppins border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:translate-y-0.5 hover:border-slate-400 hover:shadow-lg hover:bg-slate-50"
                >
                  Apply now
                </a>
              </div>
              <div className="mt-10 grid gap-6 sm:grid-cols-3">
                {[
                  ...
                  >
                    <p className="text-xs uppercase tracking-[0.2em] text-slate-500 font-poppins">
                      {item.label}
                    </p>
                    <p className="mt-2 text-lg font-semibold text-[#032d60] font-poppins">
                      {item.value}
                    </p>
                  </div>
                ))}
            ...
            <div className="scale-in">
              <div className="relative rounded-3xl border border-slate-200 bg-white p-6 shadow-lg transition hover:-translate-y-2 hover:shadow-xl hover:border-sky-100">
                ...
                <h3 className="mt-3 text-2xl font-bold text-[#032d60] font-playfair">
                  Small, senior, high-trust
                </h3>
                <p className="mt-3 font-poppins text-md md:text-[18px] text-gray-700 leading-relaxed">
                  We keep teams lean and highly collaborative. You will own
                  problems end-to-end and work closely with founders, designers,
                  and clients.
                </p>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between slide-up">
            <div>
              ...
              <h2 className="mt-3 text-3xl md:text-[35px] font-playfair font-bold text-[#032d60] leading-tight ">
                Join the team
              </h2>
            </div>
            <p className="max-w-xl font-poppins text-md md:text-[18px] text-gray-700 leading-relaxed">
              We are always looking for builders who love shipping and learning.
              Explore a few priority openings below.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2 cursor-pointer">
            {[
              {
              ...
              {
                title: "Salesforce Developer (2–3 Years)",
                type: "Full time - Onsite",
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-xl font-bold text-[#032d60] font-poppins">
                    {role.title}
                  </h3>
                ...
                <p className="mt-4 font-poppins text-md text-gray-700 leading-relaxed">
                  {role.desc}
                </p>
                <a
                  href="#apply"
                  className="mt-8 font-poppins inline-flex items-center gap-2 text-sm font-bold text-[#032d60] transition group-hover:gap-3 group-hover:text-[#032d60]"
                >
                  Apply for this role
                  <span
                    aria-hidden
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div className="slide-up">
              ...
              <h2 className="mt-3 text-3xl md:text-[35px] font-playfair font-bold text-[#032d60] leading-tight">
                Transparent from hello to offer
              </h2>
              <p className="mt-4 font-poppins text-md md:text-[18px] text-gray-700 leading-relaxed">
                We move quickly and keep communication clear at every step.
                Expect thoughtful feedback and a respectful experience.
              </p>
            </div>
            <div className="grid gap-4">
              {[
                ...
                <div
                  ...
                  style={{ animationDelay: `${idx * 150}ms` }}
                >
                  <div className="text-sm font-bold text-sky-600 bg-sky-50 rounded-lg px-3 py-2 font-poppins">
                    {item.step}
                  </div>
                  <div>
                    <p className="text-lg font-bold text-[#032d60] font-poppins">
                      {item.title}
                    </p>
                    <p className="mt-1 text-md text-slate-600 font-poppins">
                      {item.text}
                    </p>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-20">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr]">
            <div className="slide-up">
              ...
              <p className="mt-4 font-poppins text-md md:text-[18px] text-gray-700 leading-relaxed">
                Share your background and what you want to build next. We
                respond to every application within 7 days.
              </p>
              <div className="mt-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm transition hover:shadow-lg">
                <h3 className="text-lg font-bold text-[#032d60] font-poppins">
            ...
            <form
              ...
              className="rounded-3xl max-w-full overflow-hidden border border-slate-200 bg-white p-3 md:p-8 shadow-xl"
            >
              <div className="grid gap-6 grid-cols-1 sm:grid-cols-2">
                <label className="grid gap-2 text-sm min-w-0 font-bold text-slate-700 font-poppins">
                  Full Name
                  <input
                    className="h-12 rounded-xl w-full box-border min-w-0 border border-slate-200 px-4 focus:border-sky-500 outline-none"
                    name="fullName"
                    type="text"
                    required
                  />
                ...
                <label className="grid gap-2 text-sm font-bold text-slate-700 font-poppins">
                  Email Address
                  <input
                    className="h-12 rounded-xl w-full box-border border border-slate-200 px-4 focus:border-sky-500 outline-none"
                    name="email"
                    type="email"
                    required
                  />
                ...
                <label className="grid gap-2 text-sm font-bold text-slate-700 font-poppins">
                  ...
                  <div className="flex w-full">
                    {/* Country Code */}
                    <select
                      className="h-12 rounded-l-xl shrink-0 border border-slate-200 px-3 bg-gray-50 focus:border-sky-500 outline-none"
                      name="countryCode"
                      defaultValue="+91"
                    >
                    ...
                    {/* Mobile Input */}
                    <input
                      className="h-12 w-full min-w-0 rounded-r-xl border border-l-0 border-slate-200 px-4 focus:border-sky-500 outline-none"
                      name="mobile"
                      type="tel"
                      inputMode="numeric"
                      pattern="[0-9]*"
              ...
              <button
                ...
                className="mt-8 w-full rounded-full bg-[#032d60] cursor-pointer py-4 text-white font-bold transition hover:bg-[#021b3a] disabled:opacity-70"
              >
                {isSubmitting ? "Processing..." : "Submit Application"}
              </button>

              {status === "success" && (
                <p className="mt-4 text-emerald-600 text-center font-semibold">
