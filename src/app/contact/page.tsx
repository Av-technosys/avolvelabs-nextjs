          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <Card className="rounded-3xl border-none shadow-xl bg-white overflow-hidden mb-24">
              <CardContent className="p-10 md:p-14">
                <h2 className="text-5xl font-bold text-[#111827] font-playfair">Request a Call Back</h2>
                ...
                <form onSubmit={handleSubmit} className="mt-10 grid gap-6 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2 space-y-2 font-playfair"><label className="text-sm font-semibold">Message *</label><Textarea name="message" required placeholder="Tell us more..." className="bg-gray-50 min-h-30" /></div>
              ...
              <div className="bg-linear-to-r from-[#061C5B] to-[#0B2FA0] text-white p-10 rounded-3xl shadow-2xl">
                ...
                <div className="space-y-6 font-poppins">
                  <div className="flex items-start gap-4">
                    ...
                    <div><p className="font-semibold text-lg">Avolvelabs Pvt. Ltd.</p><p className="text-gray-300">Jaipur Rajasthan, India</p></div>
                  </div>
...
<section className="flex bg-white flex-col md:flex-row w-full md:min-h-[70vh] min-h-[90vh] pt-10 gap-0">
      ...
      <div className="flex-1 relative h-[50vh] md:h-[60vh]">
        <Image 
          ...
          priority
        />
        {/* Overlay: Hover par thoda dark ho jayega */}
